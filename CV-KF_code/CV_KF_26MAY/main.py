...
def print_results(results):
    ...
    print("----------------------------------------")
    print("Noisy measurements:", NOISY_MEASUREMENTS_FILE_PATH)
    print("Reference trajectory:", REFERENCE_TRAJECTORY_FILE_PATH)
    print("Trajectory:", SHEET_NAME)
    print("Observation length:", OBS_LEN)
    print("Prediction length:", PRED_LEN)
    print("Prediction Q scale:", PREDICTION_Q_SCALE)
    print("Measurement R std:", MEASUREMENT_NOISE_STD)
    print("Stride:", STRIDE)
    print("Number of windows:", results["window_count"])
    print("Number of predicted-distribution / reference pairs:", results["pair_count"])
