...
class MDN_Trainer:
    """MDN trainer class for 3D trajectory forecasting.
    """
    ...
    def train(self, data_loader):
        ...
        Expected 3D shapes:
        inputs  [batch_size, 8, 6]
        targets [batch_size, 12, 3]
        outputs [batch_size, 12, num_gaussians * 10]
        """
        ...
        for epoch in range(self.epoch, self.train_epochs+1):
            ...
            eval_data_X, eval_data_y = eval_data[0], eval_data[1]
