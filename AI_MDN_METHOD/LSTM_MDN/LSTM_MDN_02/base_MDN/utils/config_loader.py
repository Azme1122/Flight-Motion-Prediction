...
class ConfigLoader:
    ...
    def __init__(self, config_path, target, with_log, with_print, name, model_arch, type):
        ...
        self.eval_local_examples_path = os.path.join(self.result_path, 'evaluation', 'examples', 'local_step')
        ...
        self.test_local_examples_path = os.path.join(self.result_path, 'testing', 'examples', 'local_step')
        ...
        if not os.path.exists(self.eval_local_examples_path): os.makedirs(self.eval_local_examples_path)
        ...
        if not os.path.exists(self.test_local_examples_path): os.makedirs(self.test_local_examples_path)
