...
from base_transformer import Transformer_Trajectory_Forecast
...
def testing(args, gpu_id):
    ...
    for cfg in configs:
        ...
        summary_path = generate_summary_table(
            ...
            model_name="Transformer-MDN",
            title="Transformer-MDN Window-Ego Evaluation Summary"
        )
        ...
        if cfg.test_params['plot_examples'] or cfg.test_params['plot_examples_to_map']:
            ...
            eval_forecaster.save_examples(
                ...
                plot_ego=cfg.test_params['plot_examples'],
