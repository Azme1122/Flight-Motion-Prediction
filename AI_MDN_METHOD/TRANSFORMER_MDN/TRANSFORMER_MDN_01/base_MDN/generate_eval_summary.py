...
def generate_summary_table(testing_dir, model_name="Transformer-MDN", title="Transformer-MDN Evaluation Summary"):
...
def main():
    ...
    parser.add_argument("--model-name", default="Transformer-MDN")
    parser.add_argument("--title", default="Transformer-MDN Evaluation Summary")
